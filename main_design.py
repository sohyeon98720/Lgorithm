...
class WindowClass(QMainWindow, form_class):
    def __init__(self):
        ...
        self.radioButton_online.clicked.connect(self.onlineSelect)
        self.radioButton_offline.clicked.connect(self.offlineSelect)
        self.connect = ForUI()
    ...
    def changeWindowFunction(self):  ### TODO: [승건]창 하나만 띄워졌으면 좋겠음
        if self.if_cust and self.chnl_flag:
    ...
    def onlineSelect(self):
        self.chnl_dv = 2
        self.chnl_flag = True

    def offlineSelect(self):
        self.chnl_dv = 1
        self.chnl_flag = True
